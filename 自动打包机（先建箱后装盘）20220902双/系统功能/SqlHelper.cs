    ...
    public static class SqlHelper
    {
        ...
        public static bool  CreatMysqltable()
        {
            try
            {
                ...
                mcon.Open();
                //生产数据
                string sqlcom = "create table if not exists  `scancz02` (`ID` int UNSIGNED AUTO_INCREMENT,`Time` datetime not null,`Barcode` varchar(30) not null,`BoxSn` varchar(20) not null,`Groupp` varchar(60) not null,`OperID` varchar(20) not null,`Checker` varchar(20) not null,primary key (`ID`))";
